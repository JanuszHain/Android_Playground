package pl.janusz.hain.androidplayground.models.people.group;
...
import pl.janusz.hain.androidplayground.models.people.person.PersonComparator;
...
public final class Group implements Serializable {
    ...
    public String getTitleOfGroup() {
        return "Group with " + peopleInGroup.size() + " people";
    }
}
